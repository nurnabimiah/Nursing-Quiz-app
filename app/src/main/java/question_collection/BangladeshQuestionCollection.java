...
import com.bongoacademy.quiz.QuestionModule;
import com.bongoacademy.quiz.R;
import com.bongoacademy.quiz.RightActivity;
import com.bongoacademy.quiz.ScoreActivity;
import com.bongoacademy.quiz.WrongActivity;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class BangladeshQuestionCollection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(BangladeshQuestionCollection.this)
    ...
    protected void onResume() {
        super.onResume();
        if(rootLay!=null) rootLay.startAnimation(AnimationUtils.loadAnimation(BangladeshQuestionCollection.this, R.anim.middle_to_top));
    }
    ...
    //====================================================================
    //====================================================================
    public static  ArrayList <QuestionModule> questions1;

    ///..........question is here.........
    public static void createQuestionBank(){
        BangladeshQuestionCollection.subjectList = new ArrayList<>();
        BangladeshQuestionCollection.questionBank = new ArrayList<>();
        ...
        questions1 = new ArrayList(){
            {
                add(new QuestionModule("পাগলরা সব কোথায় থাকে ?", "A", "অফসারুল ইসলাম আদর", "তৌফিক আলম", "মাসুমুল হক", "জুবায়ের হোসেন"));
                add(new QuestionModule("পাগলরা সব কোথায় থাকে ?", "A", "ঢাকা", "খুলনা","বরিশাল", "ফেনী"));
                add(new QuestionModule("পাগলরা সব কোথায় থাকে ?", "A", "টাকা", "ডলার","রুপি", "বাথ"));
                add(new QuestionModule("বপাগলরা সব কোথায় থাকে ?", "D", "২৬ মার্চ", "২১ ফেব্রুয়ারি","১৪ ডিসেম্বর", "১৬ ডিসেম্বর"));
                add(new QuestionModule("স্পাগলরা সব কোথায় থাকে ?", "B", "৫ টি", "৭ টি", "৯ টি" , "১০ টি"));
        ...
        QuestionModule.createQuestionsForSubject("সাধারন জ্ঞান", R.drawable.category_icon1, questions1);
